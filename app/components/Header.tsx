...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between h-16 px-4 bg-white/80 dark:bg-[#0B1120]/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link 
            href="mailto:contact@tavily.com"
            className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
          >
